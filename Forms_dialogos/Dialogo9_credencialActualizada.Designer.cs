...
{
    partial class Dialogo9_credencialActualizada
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            btn_generar.Location = new Point(547, 272);
            btn_generar.Name = "btn_generar";
            btn_generar.Size = new Size(115, 48);
            btn_generar.TabIndex = 37;
            ...
            // btn_credActual
            // 
            btn_credActual.Anchor = AnchorStyles.None;
            btn_credActual.BackColor = Color.DarkGreen;
            btn_credActual.Enabled = false;
            btn_credActual.FlatAppearance.BorderSize = 0;
            btn_credActual.FlatStyle = FlatStyle.Flat;
            btn_credActual.Font = new Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point);
            btn_credActual.ForeColor = Color.White;
            btn_credActual.Image = Properties.Resources.pdf;
            btn_credActual.Location = new Point(374, 272);
            btn_credActual.Name = "btn_credActual";
            btn_credActual.Size = new Size(142, 48);
            btn_credActual.TabIndex = 38;
            btn_credActual.Text = "Guardar credencial actual";
            btn_credActual.TextImageRelation = TextImageRelation.TextBeforeImage;
            btn_credActual.UseVisualStyleBackColor = false;
            btn_credActual.Click += btn_credActual_Click;
            // 
            // Dialogo9_credencialActualizada
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            BackColor = Color.White;
            ClientSize = new Size(680, 335);
            Controls.Add(btn_credActual);
            Controls.Add(btn_generar);
            Controls.Add(panel1);
            Controls.Add(cb_credencial);
            Controls.Add(label1);
            Name = "Dialogo9_credencialActualizada";
            ShowIcon = false;
